...
def compute_src_dst_max_time_shifts(src_node_ids: np.ndarray, dst_node_ids: np.ndarray, node_interact_times: np.ndarray):
    """
    ...
    max_time_shift = max(np.max(src_node_all_time_shifts), np.max(dst_node_all_time_shifts))

...
def get_link_prediction_data(dataset_name: str, val_ratio: float = 0.15, test_ratio: float = 0.15, dataset_path='./../dataset', use_edge_feat=False,use_node_feat=False, logger=None):
    """
    ...
    if dataset_name in TGB_Seq_DATA_NAME:
        ...
        dataset = LinkPropPredDataset(name=dataset_name, root='../../dataset', preprocess=True)

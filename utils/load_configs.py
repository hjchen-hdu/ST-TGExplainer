...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str,default='wikipedia', help='dataset to be used')
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--multi_negs_batch_size', type=int, default=20, help='batch size')
    parser.add_argument('--model_name', type=str, default='ST_TGExplainer', help='name of the model, note that EdgeBank is only applicable for evaluation')
    ...
    parser.add_argument('--shuffle', action='store_true', default=True, help='whether to shuffle the training set')
    ...
    parser.add_argument('--output_cat_time_intervals', action='store_true', default=True, help='whether to concatenate elapsed time encoding in CRAFT')
    parser.add_argument('--output_cat_repeat_times', action='store_true', default=True, help='whether to concatenate repeat time encoding in CRAFT')
    ...
    parser.add_argument('--info_weight', type=float, default=0.1, help='information weight for the ST-TGExplainer')
    parser.add_argument('--dis_weight', type=float, default=0.1, help='dis weight for the IBExplainer')
    parser.add_argument('--disc_lr', type=float, default=0.0001, help='learning rate for adversarial discriminator')
    parser.add_argument('--use_explain', action='store_true', default=True, help='whether to explain the model')
    parser.add_argument('--use_mrr', action='store_true', default=True, help='whether to test mrr')
